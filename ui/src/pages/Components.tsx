...
// plus local notification and error-boundary previews.
...
export default function ComponentsPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Section title="Table" hint="sample data · scrolls horizontally on small screens">
      ...
      <Section title="Errors & notifications" hint="preview notification styles">
        <div className="flex flex-wrap items-center gap-2.5">
          <button
          ...
          <button
            className="btn btn-secondary"
            onClick={() => push("error", "This is an example error notification.")}
          >
            <IconXCircle size={16} /> Error toast
          </button>
          <button
            className="btn btn-secondary"
            onClick={() => push("warning", "This is an example warning notification.")}
          >
            <IconAlertTriangle size={16} /> Warning toast
          </button>
        </div>
        <ErrorBoundary
